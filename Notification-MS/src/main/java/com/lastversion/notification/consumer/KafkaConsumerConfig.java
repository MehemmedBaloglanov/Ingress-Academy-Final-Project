...
public class KafkaConsumerConfig {
    ...
    public ConsumerFactory<String, String> consumerFactory() {
        ...
        config.put(ConsumerConfig.BOOTSTRAP_SERVERS_CONFIG, "localhost:9092"); // Kafka sunucu adresi
        config.put(ConsumerConfig.GROUP_ID_CONFIG, "user-ms-group"); // Consumer group ID
